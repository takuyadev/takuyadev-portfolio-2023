         ...
         highlights: [
            {
               ...
               description: "Updated personal portfolio using Next.js and Styled Components; utilizing the Static Site Generation to vastly increase performance and load time.",
               type: "personal",
               location: "Personal",
            ...
            },
            {
               ...
               description: "Weather application that detects your current location, and calls the OpenWeather API to grab current weather conditions around your area.",
               type: "personal",
               location: "Personal",
            ...
            },
            {
               ...
               description: "Ghibli movie searching application using API calls to the movie database, as well as a feature for persisting favorites using localStorage.",
               type: "personal",
               location: "Personal",
