    ...
    experience: [
      {
        ...
        subtitle: "Diploma, Web Development Program",
        time: "February 2023 - May 2023",
        description:
          "At Lighthouse labs, we were in a dynamic and intensive 3-month program focusing on the acquisition of comprehensive modern web development skills. Curriculum highlights include mastering web frameworks, understanding data structures and algorithms, and applying test-driven development techniques.",
        list: [
          "Intense 3 month program with 12+ hours days",
          "Learned modern Fullstack Web Development workflow using React.js, Node.js and Ruby on Rails",
          "Collaborated in multiple team projects using Github for version control",
        ],
      ...
      },
      {
        ...
        description:
          "At Digital Design and Development, we learned modern web development frameworks and design software to create multiple cross-platform applications within various team environments that worked to solve issues users face every day. Graduated with distinction with a 3.67 GPA.",
        list: [
...

      {
        ...
        time: "July 2022",
        description:
          "The Frontend Developer Career Path is a 70-hour interactive online course covering all the nuances of modern frontend web development. It allows students to build multiple projects, including hands-off projects that challenge their problem-solving skills.",
        list: [
    ...
    work: [
      {
        ...
        description:
          "At ScopeMedia for an internship, I was assigned to Frontend Development and UX / UI Design role, where I was to develop a demo website for clients to showcase the company's new AI Stylist SaaS. Later that year, I was hired as a contractor in a UX / UI Design and Frontend Development role and tasked to create design systems, prototypes, recommendations, and overlook documentation for the new ScopeX website.",
        list: [
